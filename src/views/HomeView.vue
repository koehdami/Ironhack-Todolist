        ...
        <div class="col-sm-5 col-8 p-sm-0 px-2">
          <div class="input-group mb-3">
            ...
            <div class="input-group-append">
              <button
                @click="taskStore.createTask(title, userStore.user.user.id)"
      ...
      <div v-for="task in taskStore.tasks" class="container-fluid py-3" id="keys">
        ...
        <div :id="'taskRowEdit_' + task.id" class="d-none">
          ...
          <div :id="'deleteBtn_' + task.id" class="col-sm-2 col-3 px-1">
            <button @click="taskStore.deleteTask(task.id)" class="btn btn-danger w-100">Delete</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row d-flex justify-content-center">
        <div v-if="register" class="col-4 d-flex flex-column gap-2">
          <input class="form-control" placeholder="Write your email" v-model="email" />
          <input class="form-control" placeholder="Write your password" v-model="password" />
          <div>
        ...
        >
          <input class="form-control" placeholder="Write your email" v-model="email" />
          <input class="form-control" placeholder="Write your password" v-model="password" />
          <input class="form-control" placeholder="Confirm your password" v-model="passwordConfirm" />
          <div>
            <button
